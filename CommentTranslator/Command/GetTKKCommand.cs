...
namespace CommentTranslator.Command
{
    ...
    internal sealed class GetTKKCommand
    {
       ...
       // public static readonly Guid CommandSet = new Guid("a957190e-e8f5-4158-94c9-06e36f63c123");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTKKCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private GetTKKCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new GetTKKCommand(package, commandService);
        }
