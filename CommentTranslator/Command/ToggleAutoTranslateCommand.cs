...
namespace CommentTranslator.Command
{
    ...
    internal sealed class ToggleAutoTranslateCommand
    {
        ...
        private ToggleAutoTranslateCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in ToggleAutoTranslateCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new ToggleAutoTranslateCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            //string title = "ToggleAutoTranslateCommand";
